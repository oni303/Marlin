...
const short temptable_101[][2] PROGMEM = {
   ...
   {  69*OVERSAMPLENR,  201},
   {  86*OVERSAMPLENR,  187},
   { 103*OVERSAMPLENR,  177},
   { 120*OVERSAMPLENR,  168},
   { 137*OVERSAMPLENR,  161},
   { 154*OVERSAMPLENR,  155},
   { 171*OVERSAMPLENR,  149},
   { 188*OVERSAMPLENR,  144},
   { 205*OVERSAMPLENR,  139},
   { 222*OVERSAMPLENR,  135},
   { 239*OVERSAMPLENR,  131},
   { 256*OVERSAMPLENR,  127},
   { 273*OVERSAMPLENR,  124},
   { 290*OVERSAMPLENR,  120},
   { 307*OVERSAMPLENR,  117},
   { 324*OVERSAMPLENR,  114},
   { 341*OVERSAMPLENR,  111},
   { 358*OVERSAMPLENR,  109},
   { 375*OVERSAMPLENR,  106},
   { 392*OVERSAMPLENR,  103},
   { 409*OVERSAMPLENR,  101},
   { 426*OVERSAMPLENR,   99},
   { 443*OVERSAMPLENR,   96},
   { 460*OVERSAMPLENR,   94},
   { 477*OVERSAMPLENR,   92},
